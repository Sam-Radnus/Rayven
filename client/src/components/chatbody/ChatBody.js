...
function Snippet({ text }) {
 ...
 const addSnippet = () => {
            ...
            <div key={index} className={getChatMessageClassName(message.user)}>
              ...
              <div style={{backgroundColor:'#1C2A39'}} className="flex-shrink-1 ml-1 rounded py-2 px-3 mr-3">
                <div  className="font-weight-bold mb-1">{message.userName}
                  <button type="button" style={{backgroundColor:'#1C2A39',border:'none'}} onClick={() => getSentimentVal(message?.emotion)} data-bs-toggle="modal" data-bs-target="#exampleModal">
  ...
  <path d="M15.985 8.5H8.207l-5.5 5.5a8 8 0 0 0 13.277-5.5zM2 13.292A8 8 0 0 1 7.5.015v7.778l-5.5 5.5zM8.5.015V7.5h7.485A8.001 8.001 0 0 0 8.5.015z"/>
      ...
      <div style={{backgroundColor:'#27292D'}}className="flex-grow-0 py-3 px-4">
