...
const ChatBody = ({ match, currentChattingMember, setOnlineUserList }) => {
  ...
  const toHTML=(message)=>{
    ...
    .replace(/(<table>[\s\S]*<\/table>)/gm, '<div class="table-responsive">$1</div>') // table responsive
        ...
        <div className="d-flex align-items-center py-1">
          <div className="position-relative">
            ...
            <button type="button" className="btn btn" style={{ position: 'absolute', top: '25%', right: '150%' }} onClick={() => {
              ...
              <svg style={{ color: 'white' }} xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
